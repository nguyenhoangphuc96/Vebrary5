...
public class CircularCompletionView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        paint.setColor(this.getResources().getColor(R.color.colorBackgroundToolbarBlue));  // circle stroke color- blue
        ...
        paint.setColor(this.getResources().getColor(R.color.colorRed));  // circle stroke color(indicating completion Percentage) - red
        paint.setStrokeWidth(strokeSize);
